    ...
    if (fona.available())      //any data available from the FONA?
    {
      ...
      *bufPtr = 0;
      ...
      if (1 == sscanf(fonaNotificationBuffer, "+CMTI: " FONA_PREF_SMS_STORAGE ",%d", &slot)) 
      {
        ...
        //  char textBuffer[textForSMS.length() + 1];  // Create a char array of appropriate length
        //  strncpy(textBuffer, textForSMS.c_str(), sizeof(textBuffer));  // Copy textForSMS into textBuffer
        //  textBuffer[sizeof(textBuffer) - 1] = '\0';
        //  fona.sendSMS(callerIDbuffer,textBuffer);
